...
<legend><?php echo WORDING_REGISTER; ?></legend>
	<form method="post" action="?register">
		...
		<input id="user_name" type="text" pattern="[a-zA-Z0-9]{2,64}" name="user_name" value="<?php echo (isset($_POST['user_name']) ? $_POST['user_name'] : ''); ?>" required />
        ...
        <br/><img src="/vendor/devplanete/php-login-advanced/tools/showCaptcha.php" alt="captcha" />
